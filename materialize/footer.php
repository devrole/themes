                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                <p>
                                    ...
                                    <span class="copyright"><?php echo mythemes_validate_copyright( get_theme_mod( 'mythemes-copyright' , sprintf( __( 'Copyright &copy; %s %s. Modified by %s.' , 'materialize' ) , date( 'Y' ) , esc_html( get_bloginfo( 'name' ) ) , '<a href="http://devrole.com/">WordPress</a>' ) ) ); ?></span>
                                    <?php
                                        /**
                                         *
