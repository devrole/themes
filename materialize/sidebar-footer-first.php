 ...
 */
     ...
     */
        ...
        echo '<h5>' . __( 'About Us' , 'materialize' ) . '</h5>';
        echo '<div class="textwidget">';
        echo sprintf( __( 'Modified from a WordPress theme %s with creative material design and %s responsive layout.' , 'materialize' ), '<br/>' , '<br/>' );
        echo '</div>';
        echo '</div>';
    }
?>